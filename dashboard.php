...
<div class="mb-4">
    ...
    <div class="alert alert-info">
        ...
        Selamat datang <span class="text-uppercase"><b><?php echo $_SESSION['nama_lengkap']; ?>!</b></span>
    </div>
    <?php
    ...
    <div class="row">
        ...
        <?php
            $no = 1;
            $query = mysqli_query($koneksi,"SELECT f.*, u.* from foto f inner join user u on f.user_id=u.user_id ORDER BY f.foto_id DESC");
