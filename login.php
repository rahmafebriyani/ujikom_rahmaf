                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            ...
                                            <h1 class="h5 text-left text-gray-900 mb-4 mt-3">Login Akun</h1>
                                        </div>
										<?php if(!empty($errors)): ?>
                                        ...
                                        <form class="user" action="login.php" method="post">
                                            ...
                                            <a href="daftar.php" class="btn btn-danger btn-user btn-block"><i class="fas fa-fw fa-sign-up-alt mr-1"></i> Daftar</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
